...
import webbrowser
webbrowser.open('https://youtube.com/channel/UCf1_5PSc8lgdPPQpVH1hGrw')
os.system('clear')
Z = '\x1b[1;31m'
A = '\x1b[1;33m'
Z1 = '\x1b[2;31m'
